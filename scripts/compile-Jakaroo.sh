...
circom circuits/Jakaroo.circom --r1cs --wasm --sym -o Jakaroo
snarkjs r1cs info Jakaroo/Jakaroo.r1cs

# Start a new zkey and make a contribution

snarkjs groth16 setup Jakaroo/Jakaroo.r1cs powersOfTau28_hez_final_12.ptau Jakaroo/circuit_0000.zkey
